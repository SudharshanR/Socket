...
public abstract class CountPOA extends org.omg.PortableServer.Servant
 implements CounterPOA.CountOperations, org.omg.CORBA.portable.InvokeHandler
{
                                ...
                                org.omg.CORBA.portable.ResponseHandler $rh)
  {
    ...
    {
       case 0:  // CounterPOA/Count/_get_sum
       {
         int $result = (int)0;
         $result = this.sum ();
         out = $rh.createReply();
       ...
       case 1:  // CounterPOA/Count/_set_sum
       {
       ...
       case 2:  // CounterPOA/Count/increment
       {
         int $result = (int)0;
